...
subroutine mexFunction(nlhs, plhs, nrhs, prhs)
    ...
    call mxCopyPtrToReal8(mxGetPr(prhs(13)),knots1,n1)
    call mxCopyPtrToReal8(mxGetPr(prhs(14)),knots2,n2)
    ...
    call mxCopyPtrToReal8(mxGetPr(prhs(12)),lam,1)

	call calcpar(y1mat,y2mat,p1mat,p2mat,v1mat,v2mat,Gu,Pu,invT1,invT2)
