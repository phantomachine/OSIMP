...
k = 5;
rvec = linspace(1.0,5.0,41);
%rvec = [1.0 2.0 5.0];

for i = 1:size(rvec,2)

    iota = rvec(i);
    filename = ['k', num2str(k,'%1d'), '_ny', num2str(n1,'%1d'), 'nx', num2str(nx,'%1d'), 'ymax', num2str(ymax,'%1.1f'), '_iota', num2str(iota,'%1.1f')];
    disp(filename);
    calcscp;
    eval(['save ./mat/pfsc_', filename, '.mat bet eta rho sig kap1 kap2 iota Gu Pu knots1 knots2 knotsx x1mat x2mat y1mat y2mat p1mat p2mat v1mat v2mat zmat xmat w1mat w2mat;']);    
    plotif;
