...
subroutine calcnc(y1mat,y2mat,p1mat,p2mat,v1mat,v2mat,Gu,Pu,invT1,invT2)
        ...
        do iu = 1,nu
            ...
            do i1 = 1,n1
                ...
                do i2 = 1,n2
                    ...
                    ! eq. (1)
                    v1 = -(2.0d0*(1.0d0+eta)*y1**2 - (2.0d0-neu)*(1.0d0+eta)*(y1 - 1.0d0/(eta+1.0d0)*u1)**2 &
                    + (2.0d0-neu)*(1.0d0+eta)*(y2 + 1.0d0/(eta+1.0d0)*u2)**2 &
                    + sig*(2.0d0-neu)/kap1*p1**2 + sig*neu/kap1*p2**2) + bet*v1f
                    ! eq. (2)
                    v2 = -(2.0d0*(1.0d0+eta)*y2**2 - (2.0d0-neu)*(1.0d0+eta)*(y2 - 1.0d0/(eta+1.0d0)*u2)**2 &
                    + (2.0d0-neu)*(1.0d0+eta)*(y1 + 1.0d0/(eta+1.0d0)*u1)**2 &
                    + sig*(2.0d0-neu)/kap1*p1**2 + sig*neu/kap1*p2**2) + bet*v2f
