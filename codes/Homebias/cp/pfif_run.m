...
for i = 1:size(rvec,2)
    ...
    disp(filename);
    [y1mat y2mat p1mat p2mat v1mat v2mat] = calccp(Gu,Pu,invTy,invTy,bet,eta,rho,sig,kap1,kap2,neu,knotsy,knotsy);
    eval(['save ./mat/pfcp_', filename, '.mat bet eta rho sig kap1 kap2 neu Gu Pu knotsy y1mat y2mat p1mat p2mat v1mat v2mat;']);    
    plotif;
