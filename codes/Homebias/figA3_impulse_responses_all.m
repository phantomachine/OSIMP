%Figure A3: impulse responses, home bias
clear all;
...
eval(['load ./scp/mat/ifsc_', filename_scp, '_neu1.00.mat']);
x1s_1 = y1vec - uvec;
x2s_1 = y2vec;
p1s_1 = p1vec;
p2s_1 = p2vec;
...
eval(['load ./scp/mat/ifsc_', filename_scp, '_neu1.20.mat']);
x1s_2 = y1vec - uvec;
x2s_2 = y2vec;
p1s_2 = p1vec;
p2s_2 = p2vec;
...
eval(['load ./scp/mat/ifsc_', filename_scp, '_neu0.80.mat']);
x1s_3 = y1vec - uvec;
x2s_3 = y2vec;
p1s_3 = p1vec;
p2s_3 = p2vec;
...
eval(['load ./cp/mat/ifcp_', filename, '_neu1.00.mat']);
x1c_1 = y1vec - uvec;
x2c_1 = y2vec;
p1c_1 = p1vec;
p2c_1 = p2vec;
...
eval(['load ./cp/mat/ifcp_', filename, '_neu1.20.mat']);
x1c_2 = y1vec - uvec;
x2c_2 = y2vec;
p1c_2 = p1vec;
p2c_2 = p2vec;
...
eval(['load ./cp/mat/ifcp_', filename, '_neu0.80.mat']);
x1c_3 = y1vec - uvec;
x2c_3 = y2vec;
p1c_3 = p1vec;
p2c_3 = p2vec;
...
eval(['load ./ncp/mat/ifnc_', filename, '_neu1.00.mat']);
x1n_1 = y1vec - uvec;
x2n_1 = y2vec;
p1n_1 = p1vec;
p2n_1 = p2vec;
...
eval(['load ./ncp/mat/ifnc_', filename, '_neu1.20.mat']);
x1n_2 = y1vec - uvec;
x2n_2 = y2vec;
p1n_2 = p1vec;
p2n_2 = p2vec;
...
eval(['load ./ncp/mat/ifnc_', filename, '_neu0.80.mat']);
x1n_3 = y1vec - uvec;
x2n_3 = y2vec;
p1n_3 = p1vec;
p2n_3 = p2vec;
...
if(pflag); print -depsc2 figureA3_impulse_responses_neu.eps; end;
